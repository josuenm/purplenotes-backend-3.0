      ...
      <div
        ...
        <div style="padding: 20px 0;">
            <a href="${url}/password-recovery/confirm/${id}" target="_blank"
              style="background-color: #6b03fc; color: inherit; text-decoration: none; font-weight: bold; border: 0; padding: 10px 20px; border-radius: 5px; cursor: pointer;">Create new password</a>
        </div>
      </div>
    `,
  };
